...
export function TikTokIcon(props: SVGProps<SVGSVGElement>) {
  return (
    <svg viewBox="0 0 24 24" fill="currentColor" {...props}>
      <path d="M16.6 5.82c-.9-.98-1.4-2.26-1.4-3.58h-3.28v13.3a2.6 2.6 0 1 1-2.6-2.6c.24 0 .48.03.7.09V9.7a5.9 5.9 0 0 0-.7-.04A5.85 5.85 0 1 0 15.2 15.5V9.32a8.44 8.44 0 0 0 4.8 1.5V7.55a5.5 5.5 0 0 1-3.4-1.73Z" />
    </svg>
  );
}
